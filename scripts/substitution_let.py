...
def set_var_arg(arg, var, val, flag=False):
        ...
        elif arg['type'] == '-' or arg['type'] == '+' or arg['type'] == '*' or arg['type'] == '/' or  arg['type'] == '%' or arg['type'] == '>' or arg['type'] == '>=' or arg['type'] == '<' or arg['type'] == '<=' or arg['type'] == '==' or arg['type'] == '!=' or arg['type'] == '&&' or arg['type'] == '||' or arg['type'] == '?:' or arg['type'] == 'neg':
